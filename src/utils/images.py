...
logo_path_equity_dash = os.path.join(
    cwd, "src", "assets", "logos", "dvrpc_equity_dash_logo.svg"
)
with open(logo_path_equity_dash, "rb") as logo_file:
    logo_tunel_equity_dash = base64.b64encode(logo_file.read())
logo_encoded_equity_dash = "data:image/svg+xml;base64,{}".format(
    logo_tunel_equity_dash.decode()
)
